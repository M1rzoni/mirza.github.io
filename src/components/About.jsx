      ...
      <div className="about-main-container">
        <div className="text-container">
          ...
          <p>
            ...
            Throughout my work, I strive to create high-quality applications
            that are user-centric. Additionally, <br />I regularly keep up with
      ...
      <div>
        ...
        <div className="flex-about-container hidden">
          <div className="flex">
            <img
              alt="back-end-icon"
              src="https://cdn-icons-png.flaticon.com/128/13191/13191307.png"
            ></img>
            <div className="content">
              <h1>Back-end</h1>
        ...
        <div className="flex-about-container hidden">
          <div className="flex">
            <img
              alt="back-end-icon"
              src="https://cdn-icons-png.flaticon.com/128/3344/3344281.png"
            ></img>
            <div className="content">
              <h1>Framework</h1>
        ...
        <div className="flex-about-container hidden">
          <div className="flex">
            <img
              alt="back-end-icon"
              src="https://cdn-icons-png.flaticon.com/128/1055/1055683.png"
            ></img>
            <div className="content">
